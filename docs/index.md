...
The AI Software Template that was executed comes with a sample application. This application will be built from https://github.com/mvaldron-rhdh/chatbot-test-app-50, stored in [quay.io/mvaldron-rhdh/chatbot-test-app-50](https://quay.io/mvaldron-rhdh/chatbot-test-app-50) and deployed through ArgoCD. 
